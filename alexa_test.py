...
def launched():
	#monitorHR()
	return question("hello. new robot is running").reprompt("if you don't need Sparky, please tell him to go to sleep.")
...
def goforward():
	forward()
	return question("going forward").reprompt("if you don't need Sparky, please tell him to go to sleep.")
...
def follow():
	followLoop()
	return statement('new robot has stopped following you')
